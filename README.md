...
Focusing on **GE Vernova GridOS** & **Smallworld Core Technology**.

## 🚀 Current Focus: Smallworld Core & Clean Architecture
- **Topic:** VMDS Transaction Model & Alternatives.
- **Goal:** Understand how GIS data versioning impacts external integrations.

## 📂 Learning Path
- [Architecture Designs](./01-Architecture-Designs/)
- [Smallworld Core Internals](./02-Smallworld-Core-Internals/)
- [Integrations](./03-Java-GridOS-Integrations/)
